...
var taskInput=document.querySelector(".tasks__text_new");//Add a new task.
var addButton=document.querySelectorAll(".tasks__btn")[0];//first button
...
var addTask=function(){
    ...
    //Create a new list item with the text from the .tasks__text_new:
